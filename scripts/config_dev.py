...
from scripts.config_data import HISTO_THICKNESS
from src.utils.image_transform import ScaleNormalization, NonLinearParams, RotationParams, CropParams
from database import databaseConfig

## Data characteristics
IMAGE_SHAPE = (448, 320) # Image shape of the tree vertices
BLOCK_RES = 0.25 # In-plane esolution at which perform all the experiments.
CROP_XY = [93 * BLOCK_RES, 79 * BLOCK_RES] # Image cropping of the resampled reference images.

HISTO_AFFINE = np.zeros((4, 4)) # Matrix used in the ".tree" files
