...
inter_modal = ['MRI_NISSL', 'MRI_IHC', 'IHC_NISSL']

if __name__ == '__main__':

    arg_parser = ArgumentParser(description='Computes the prediction of certain models')
    arg_parser.add_argument('--modality', type=str, choices=inter_modal, help='Modality(s) used in the registration')
    ...
    dec_nf = [64, 64, 64, 32, 32, 32, 32, 16, 16]  # [64, 64, 64, 32, 16, 16]#
    int_steps = 7
    ...
    reg_loss = reg_loss(device=device, name='registration', **parameter_dict['LOSS_REGISTRATION']['params'])

    reg_smooth_loss = losses.DICT_LOSSES[parameter_dict['LOSS_REGISTRATION_SMOOTHNESS']['name']]
    reg_smooth_loss = reg_smooth_loss(name='reg_smooth', loss_mult=parameter_dict['UPSAMPLE_LEVELS'],
